    ...
    def repl(self, use_remote: bool = True):
        ...
        while True:
            try:
                ...
                if user == "/addorigin":
                    print("\n[FREELI CONFIG] Setup Origin (Remote URL)")
                    url = input("Origin URL > ").strip()
                    if url:
